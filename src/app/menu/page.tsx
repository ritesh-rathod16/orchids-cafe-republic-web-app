...
export default function MenuPage() {
  ...
  if (orderSuccess) {
    return (
      <div className="flex h-[80vh] flex-col items-center justify-center px-6 text-center">
        ...
        <h1 className="mb-2 text-3xl font-serif font-bold">Thanks for ordering!</h1>
        ...
        <div className="flex flex-col gap-4 w-full max-w-xs">
          ...
          <Button variant="outline" onClick={() => window.location.href = '/'} className="h-14 rounded-full text-lg">
            No, Thank You
          </Button>
        </div>
      </div>
  ...
  return (
    <div className="flex flex-col pb-40 lg:pb-8">
      {/* Category Tabs */}
      <div className="sticky top-16 z-30 flex gap-2 overflow-x-auto bg-background/95 p-4 backdrop-blur-md hide-scrollbar border-b">
        {categories.map((cat) => (
          <button
            key={cat}
      ...
      {/* Bottom Cart Bar - Fixed above navigation */}
      {totalItems > 0 && !showCart && (
        <div className="fixed bottom-24 left-4 right-4 z-40 lg:bottom-8 lg:left-auto lg:right-8 lg:w-80">
          <Button 
